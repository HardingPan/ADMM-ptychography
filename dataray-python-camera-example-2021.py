...
class MyApp( wx.App ):
    ...
    def OnClick(self,e):
        ...
        if rb_selection == "WinCam":
            ...
            vert = self.gd.ctrl.GetVerticalPixels()
            hori = self.gd.ctrl.GetHorizontalPixels()
            print(vert,hori)
            data = np.array(self.gd.ctrl.GetWinCamDataAsVariant()).reshape((vert, hori))
    ...
    def __init__( self, redirect=False, filename=None ):
        ...
        self.ti = wx.TextCtrl(p, value="C:/Users/86364/Desktop/yanshetuxixang/output.csv",
